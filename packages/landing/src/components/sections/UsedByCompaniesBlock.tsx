      ...
      <div className="container text-center">
        ...
        <div className="flex flex-row flex-wrap justify-center">
          <div className="flex-shrink-0 w-32 mx-1 my-1">
            <div
              className="relative bg-less-3 rounded-full overflow-hidden"
          ...
          <div className="flex-shrink-0 w-32 mx-1 my-1">
            ...
            >
              <img
                alt="Mozilla"
                src="/static/companies/logo-mozilla.png"
                className="absolute inset-0 w-full h-full object-cover bg-black rounded-full"
              />
            </div>
          </div>
